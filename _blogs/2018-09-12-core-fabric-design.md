...
| sr-infrastructure | Associates an IGP Instance, a Loopback and a global block of labels to be re-used across the network.                                                                 |sr-infrastructure instance-name ISIS-CORE loopback 0<br>sr-global-block-pools SRGB-POOL1<br>                                                                                                           |
| sr                | Defines an sr service. Can leverage sr-infrastructure to ensure consistent IGP, loopback and global block. Can auto-assign prefix SIDs to nodes to ensure uniqueness. |```services sr DENVER ```<br/>``` router P3```<br/>```  instance-preference use-sr-infrastructure```<br/>  ```prefix-preference auto-assign-prefix-sid                                                                                               ```<br/>                                                                    |
...
| sr | Defines an sr service. Can leverage sr-infrastructure to ensure consistent IGP, loopback and global block. Can auto-assign prefix SIDs to nodes to ensure uniqueness. | ```services sr DENVER `````` router P3``````,instance-preference use-sr-infrastructure```,```prefix-preference auto-assign-prefix-sid,``` |
|----|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|
