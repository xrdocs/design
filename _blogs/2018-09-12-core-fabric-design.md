...
| **id-pool**           | Resource-pool for common global block of SR labels. Can exclude labels from range. |```resource-pools id-pool SRGB-POOL1 range start 17000 end 19000```            |
