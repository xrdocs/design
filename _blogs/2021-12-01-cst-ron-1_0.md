...
business services. OTN and IP network traffic must be converted into wavelength
...
### Where to use 400G-ZR and where to use OpenZR+
...
# Routed Optical Networking Validated Design 
