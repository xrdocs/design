...
| ---------------- | ---------------------- |-----|
| 1.0       | 05/08/2018 | Initial RON Publication 
...
and traffic engineering layers of the IP network, RON collapses complex
...
extends the key tenet of network simplification.  RON tackles the challenges of
...
hardware, ZR/ZRP DD optics can be used in the same ports as the highest speed
...
Cisco is embracing RON in every SP router role. Access, aggregation, core, peering, DCI, and 
even PE routers can be enabled with high speed DCO optics. RON is also not limited to SP networks, 
...
optic network, we still need a DWDM layer. RON is flexible enough to work across point to point or ROADM based optical networks. Cisco 
...
# RON Architecture Hardware 
All RON solution routers are powered by Cisco IOS-XR.   
...
## NCS 540 Series 
The 1Tbps N540-24QL16DD-SYS router brings QSFP-DD and RON ZR/ZRP optics to a flexible 
