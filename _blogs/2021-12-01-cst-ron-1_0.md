...
* Unified IP and Optical using Crosswork Hierarchical Controller
* Unified IP and Optical using Cisco NSO Routed Optical Networking Multi-Layer Function Pack  
* ZR/ZR+ Optics using IOS-XR CLI 
* ZR/ZR+ Optics using IOS-XR Netconf
* Cisco optical using Cisco Optical Network Controller using Restconf/TAPI  
