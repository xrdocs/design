...
the Peering Fabric and the data which can be gathered by configuring these
...
![](http://xrdocs.io/design/images/ron-hld/ron-telemetry-grafana.png){:height="100%" width="100%"}