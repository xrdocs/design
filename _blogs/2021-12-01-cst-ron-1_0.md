...
End-to-End IP+Optical provisioning can be done using HCO GUI IP Link provisioning. Those familiar with 
traditional GUI EMS/NMS systems for service management will have a very familiar experience. HCO provisioning 
will provision both the router optics as well as the underlying optical network to support the ZR/ZR+ wavelength.   
...
![](http://xrdocs.io/design/images/ron-hld/ron-hco-nmc-xconnects.png){:height="100%" width="100%"}
...
![](http://xrdocs.io/design/images/ron-hld/ron-hco-ip-link-provisioning.png){:height="100%" width="100%"}
